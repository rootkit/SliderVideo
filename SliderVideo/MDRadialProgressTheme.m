...
//  MDRadialProgress
//
//  Created by Marco Dinacci on 07/10/2017.
...
- (id)init
{
	...
	if (self) {
		// View
		self.completedColor = [UIColor colorWithRed:0.9 green:0.7 blue:0.34 alpha:1.0];
		self.incompletedColor = [UIColor colorWithRed:0.43 green:0.34 blue:0.49 alpha:1.0];
		self.sliceDividerColor = [UIColor whiteColor];
		self.centerColor = [UIColor colorWithRed:0.32 green:0.19 blue:0.36 alpha:1.0];
		self.thickness = 15;
